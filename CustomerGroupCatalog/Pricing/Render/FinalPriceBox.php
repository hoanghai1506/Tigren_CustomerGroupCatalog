...
class FinalPriceBox extends \Magento\Catalog\Pricing\Render\FinalPriceBox {
    ...
    protected function wrapResult( $html ) {
        ...
        dd($this->getSaleableItem()->getPriceInfo()->getPrice('final_price'));
        if ( $isLoggedIn ) {
            return '<div class="price-box ' . $this->getData( 'css_classes' ) . '" ' .
                   'data-role="priceBox" ' .
                   'data-product-id="' . $this->getSaleableItem()->getId() . '"' .
                   ' xmlns="http://www.w3.org/1999/html" xmlns="http://www.w3.org/1999/html">' . $html . '</br>' . '<p style="color: red">Dicount: </p>' . $resultSql[0]['discount_amount'] . '%' . '</div>';
        } else {
